...
class AutoEncoder(nn.Module):
    '''
    An autoencoder class with single input 
    '''
...
class TwinAutoEncoder(nn.Module):
    '''
    An autoencoder class with two inputs 
    '''

    def __init__(self, input_dim1: int, input_dim2: int, hidden_dims: List[int], agg: str, sep_decode: bool):
        '''
        :param input_dim1: size of first input 
        :param input_dim2: size of second input 
        :param hidden_dims: list of dimension sizes 
        :param agg: str, one of 'max','multi', 'sum', 'concat'
        :param sep_decode: bool, whether or not to decode the two inputs separately.
        '''
        super().__init__()
    ...
    def forward(self, x1: torch.FloatTensor, x2: torch.FloatTensor) -> Tuple[torch.FloatTensor, torch.FloatTensor, torch.FloatTensor]:
        z1 = self.encoder(x1)
        z2 = self.encoder2(x2)
...
class TopicCluster(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.model = TwinAutoEncoder(input_dim1, input_dim2, hidden_dims, self.agg_method, self.sep_decode)
